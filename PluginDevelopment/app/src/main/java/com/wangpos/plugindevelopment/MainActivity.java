    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.button).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    utilClass = getClassLoader().loadClass("com.wangpos.pluginapkdemo.Utils");

                    Object object =  utilClass.newInstance();

                    Method method = utilClass.getDeclaredMethod("getPluginVersion");
